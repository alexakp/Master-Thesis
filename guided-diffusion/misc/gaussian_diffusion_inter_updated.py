        ...
        #int_i = 8
            ...
            if(make_intermediate_and_gif):
                ...
                for key, value in intermediate_img_pil.items():
                    value.save(f'generated_imgs/interpolated-{int_i}_img_size_128x128.jpg') # change to .eps for PDF
                    value.save(f'generated_imgs/interpolated-{int_i}_eps_img_size_128x128.eps') # change to .eps for PDF
